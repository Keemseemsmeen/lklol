...
class HJ_ConfigExplorer
	...
	enableSimulation = 0;
	movingEnable = 0;
	onLoad = "null = _this execVM '\loki_lost_key\proving_ground\CfgExplorer2\scripts\InitDialog.sqf';";
	onUnLoad = "null = _this execVM '\loki_lost_key\proving_ground\CfgExplorer2\scripts\EndDialog.sqf';";
	...
	class tCurrentPathText:LOKI_RscText 
	{
		idc = -1;
		style = ST_FRAME;
	...
	class tCurrentPathValue:LOKI_RscText 
	{
		idc = 101;
		style = ST_LEFT;
		x = ((0.01 * SafeZoneW) + SafeZoneX);
	...
	class tConfigText:LOKI_RscText 
	{
		idc = -1;
		style = ST_RIGHT;
	...
	class lbClasses:RscIGUIListBox 
	{
		...
		onLBDblClick = "_this execVM '\loki_lost_key\proving_ground\CfgExplorer2\scripts\onDoubleClickClass.sqf';";
	};
	
	class frmValues:LOKI_RscText
	{
		idc = -1;
		type = CT_STATIC;
		style =  ST_FRAME;
	...
	class sbtnDumpClasses:RSC_HJ_ShortcutButton 
	{
		...
		onButtonClick = "_this execVM '\loki_lost_key\proving_ground\CfgExplorer2\scripts\onButtonClick_dump.sqf';";
	};
	...
	class sbtnUp:RSC_HJ_ShortcutButton 
	{
		...
		onButtonClick = "_this execVM '\loki_lost_key\proving_ground\CfgExplorer2\scripts\onButtonClick_up.sqf';";
	};
	
	class frmOrder:LOKI_RscText
	{
		idc = -1;
		type = CT_STATIC;
		style =  ST_FRAME;
	...
	class sbtnCopyClip:RSC_HJ_ShortcutButton
	{
		...
		action = "allText = ctrlText 113; copyToClipboard allText;";
	}
	
	class tVersion:LOKI_RscText 
	{
		style = ST_RIGHT;
