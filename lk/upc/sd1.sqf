...
_mapMarkText = "Click on the map to designate the vehicle drop LZ";
_closeMapMessage = "Close the map to initiate drop procedure";
_droppoint = "SD_DropMarker";
_dropMarkerType = "Airport";
_incomingMessage = "This is eagle one, we are inbound with vehicle drop, please stand by...";
...
if ace2vehdrop then {
spawntype0 = "ACE_M1A1HC_DESERT";
spawntype1 = "ACE_M2A2_D";
spawntype2 = "ACE_ATV_Honda_Desert"} else {

spawntype0 = "M1A1";
spawntype1 = "LAV25";
spawntype2 = "HMMWV_Armored"
...
while {_vehicle distance _target > 40} do {
    ...
    _chute = "ParachuteBigWest" createVehicle getpos _bomb;
...
hint "Vehicle Drop is available again";
supply=true;
nul = [player] execVM "\loki_lost_key\lk\menu\close_menu.sqf";
