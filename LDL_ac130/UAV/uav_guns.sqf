	...
	switch (_weapon) do
	{
		...
		case 0:
		{
			...
			else
			{
				...
				[_hellfire, LDL_logic_object, LDL_ac130_plane] execVM "\loki_lost_key\LDL_ac130\Misc\mando_hellfire.sqf";
			};
		};	
			...
			if(_i >= 14) then
			{
				...
				else
				{
					...
					for [{_i = 0;},{_i < 3;},{_i = _i + 1;}] do 
					{
						...
						[_hellfire, _target, LDL_ac130_plane] execVM "\loki_lost_key\LDL_ac130\Misc\mando_hellfire.sqf";
						sleep 1;	
					};
				};
