...
LDL_weaponSlots = 
[
	["Hellfire (Mounted)", 8, LDL_ac130_plane ammo "HellfireLauncher", false, "", "\loki_lost_key\LDL_ac130\Pictures\VisTV.paa", LDL_options select 10], 
	["Hellfire Strike", 3, _currentStrikes, false, "", "\loki_lost_key\LDL_ac130\Pictures\VisTV.paa", LDL_options select 10]
];
