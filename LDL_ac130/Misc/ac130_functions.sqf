...
LDL_setVariables = 
{
	...
	LDL_weaponSlots = 
	[
		["25mm", (LDL_options select 2), _current25mm, false, LDL_ammo select 0, "\loki_lost_key\LDL_ac130\Pictures\Vis25mm.paa", LDL_options select 10], 
		["40mm", (LDL_options select 3), _current40mm, false, LDL_ammo select 1, "\loki_lost_key\LDL_ac130\Pictures\Vis40mm.paa", LDL_options select 11], 
		["105mm", (LDL_options select 4), _current105mm, false, LDL_ammo select 2, "\loki_lost_key\LDL_ac130\Pictures\Vis105mm.paa", LDL_options select 12]
	];
