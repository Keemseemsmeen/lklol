...
if(LDL_plane_type == "AC130_ROTATE" || LDL_plane_type == "AC130_AI") then
{
	...
	_pilot = ([_faction]call _getPilotClass) createUnit [[0,0,10000],createGroup _side,"_pilot = this; this moveInDriver LDL_ac130_plane;", 0.6, "corporal"];
};
...
if(LDL_plane_type == "UAV") then
{
	...
	else
	{
		...
		_pilot = ([_faction]call _getPilotClass) createUnit [[0,0,10000],createGroup _side,"_pilot = this; this moveInGunner LDL_ac130_plane;", 0.6, "corporal"];	
	};
};