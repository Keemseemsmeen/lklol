...
if (isNil "KEGs_FuncsInited") then {
	...
	call compile preprocessFileLineNumbers "\loki_lost_key\spect\spect_funcs.sqf";
	spectate_events = compile preprocessFileLineNumbers "\loki_lost_key\spect\specta_events.sqf";
	KEGs_menucamslbchange = compile preprocessFileLineNumbers "\loki_lost_key\spect\menucamslbchange.sqf";
};
...
if (KEGs_no_butterfly_mode) exitWith {
	...
	[] spawn {sleep 0.01; [_player, _killer, "noWait"] execVM "\loki_lost_key\spect\specta.sqf"};
};
...
deletevehicle _bird;
KEGs_SPECTATINGON = nil;
[_player, _killer, "noWait"] execVM "\loki_lost_key\spect\specta.sqf";