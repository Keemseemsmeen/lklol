...
private ["_grpLogicSOM", "_somSearch"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somSearch = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somSearch synchronizeObjectsAdd [player];
...
_somSearch setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somSearch] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somSearch getVariable "mainScope";
