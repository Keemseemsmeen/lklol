...
private ["_grpLogicSOM", "_somAttack"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somAttack = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somAttack synchronizeObjectsAdd [player];
...
_somAttack setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somAttack] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somAttack getVariable "mainScope";
