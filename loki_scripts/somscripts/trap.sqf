...
private ["_grpLogicSOM", "_somTrap"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somTrap = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somTrap synchronizeObjectsAdd [player];
...
_somTrap setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somTrap] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somTrap getVariable "mainScope";
