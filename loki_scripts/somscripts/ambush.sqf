...
private ["_grpLogicSOM", "_somAmbush"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somAmbush = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somAmbush synchronizeObjectsAdd [player];
...
_somAmbush setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somAmbush] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somAmbush getVariable "mainScope";
