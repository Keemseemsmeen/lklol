...
private ["_grpLogicSOM", "_somEscort"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somEscort = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somEscort synchronizeObjectsAdd [player];
...
_somEscort setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somEscort] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somEscort getVariable "mainScope";
