...
private ["_grpLogicSOM", "_somDefend"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somDefend = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somDefend synchronizeObjectsAdd [player];
...
_somDefend setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somDefend] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somDefend getVariable "mainScope";
