...
private ["_grpLogicSOM", "_somPatrol"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somPatrol = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somPatrol synchronizeObjectsAdd [player];
...
_somPatrol setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somPatrol] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somPatrol getVariable "mainScope";
