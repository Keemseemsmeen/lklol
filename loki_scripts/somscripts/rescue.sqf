...
private ["_grpLogicSOM", "_somRescue"];
createCenter sideLogic;
_grpLogicSOM = createGroup sideLogic;
_somRescue = _grpLogicSOM createUnit ["SecOpManager", [1, 1, 1], [], 0, "NONE"];
_somRescue synchronizeObjectsAdd [player];
...
_somRescue setVariable ["settings", _settings];

[] spawn
{
	Sleep 10;
	[["transport", "aerial_reconnaissance", "supply_drop", "tactical_airstrike", "artillery_barrage"], _somRescue] call BIS_SOM_addSupportRequestFunc;
};

SOM_mainScope = _somRescue getVariable "mainScope";
