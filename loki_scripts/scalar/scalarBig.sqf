...
while {alive _tower} do
{
	...
	_PS setParticleParams [[_shape, 8, 2, 0], "", _type, _timer, _life, _position, [0, 0, 0], 5, _weight, _vol, _rub, _size, _color, [1], 0, 0, "", "", _tower];
	_PS1 setParticleParams [[_shape2, 1, 0, 1], "", _Type2, _timer, _life2, _position2, [0, 0, 0], 5, _weight2, _vol2, _rub2, _size2, _color, [1], 0, 0, "", "", _tower];		
	sleep 0.01;
};
...
YNH = [scalarTower98b,6] execVM "\loki_lost_key\loki_scripts\scalar\nuke.sqf";
//sleep 4;
