...
class DlgViewer
{
	...
	class ButtonAdd: CLAY_AV_RscButton
	{
		idc = 230;
		text = "Add";
		action = "[1] execVM '\loki_lost_key\AnimationViewer\store.sqf'";
	...
	class ButtonRemove: CLAY_AV_RscButton
	{
		idc = 231;
		text = "Remove";
		action = "[2] execVM '\loki_lost_key\AnimationViewer\store.sqf'";
	...
	class ButtonCopy: CLAY_AV_RscButton
	{
		idc = 235;
		text = "Copy";
		action = "[3] execVM '\loki_lost_key\AnimationViewer\store.sqf'";
	...
	class ButtonSearch: CLAY_AV_RscButton
	{
		idc = 234;
		text = "Search";
		action = "[] execVM '\loki_lost_key\AnimationViewer\search.sqf'";
	...
	class ButtonZoomIn: CLAY_AV_RscButton
	{
		idc = 221;
		text = "ZOOM +";
		action = "[1] execVM '\loki_lost_key\AnimationViewer\campos.sqf'";
		x = (0.515 * SafeZoneW + SafeZoneX);
	...
	class ButtonZoomOut: CLAY_AV_RscButton
	{
		idc = 222;
		text = "ZOOM -";
		action = "[2] execVM '\loki_lost_key\AnimationViewer\campos.sqf'";
		x = (0.515 * SafeZoneW + SafeZoneX);
	...
	class ButtonCamFront: CLAY_AV_RscButton
	{
		idc = 224;
		text = "Front";
		action = "[3] execVM '\loki_lost_key\AnimationViewer\campos.sqf'";
		x = (0.765 * SafeZoneW + SafeZoneX);
		y = (0.74 * SafeZoneH + SafeZoneY);
		w = (0.1 * SafeZoneW);
		h = (0.025 * SafeZoneH);
	...
	class ButtonCamBack: CLAY_AV_RscButton
	{
		idc = 225;
		text = "Back";
		action = "[4] execVM '\loki_lost_key\AnimationViewer\campos.sqf'";
		x = (0.765 * SafeZoneW + SafeZoneX);
		y = (0.765 * SafeZoneH + SafeZoneY);
		w = (0.1 * SafeZoneW);
		h = (0.025 * SafeZoneH);
	...
	class ButtonCamLeft: CLAY_AV_RscButton
	{
		idc = 226;
		text = "Left";
		action = "[5] execVM '\loki_lost_key\AnimationViewer\campos.sqf'";
	...
	class ButtonCamRight: CLAY_AV_RscButton
	{
		idc = 227;
		text = "Right";
		action = "[6] execVM '\loki_lost_key\AnimationViewer\campos.sqf'";
		x = (0.875 * SafeZoneW + SafeZoneX);
		y = (0.765 * SafeZoneH + SafeZoneY);
		w = (0.1 * SafeZoneW);
		h = (0.025 * SafeZoneH);
